<%@ Page Title="" Language="C#" MasterPageFile="~/navbar.Master" AutoEventWireup="true" CodeBehind="group.aspx.cs" Inherits="WISLEY.group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="nav nav-tabs">
        <ul class="nav tabs-black rounded-0" id="myClassicTabShadow" role="tablist">
            ...
            <li class="nav-item m-0">
                <a class="nav-link waves-light" id="resources-tab-classic-shadow" data-toggle="tab"
                    href="#resources-classic-shadow" role="tab" aria-controls="resources-classic-shadow"
                    aria-selected="true">Resources</a>
            </li>

            <li class="nav-item m-0">
                <a class="nav-link waves-light" id="assignments-tab-classic-shadow" data-toggle="tab"
                    href="#assignments-classic-shadow" role="tab" aria-controls="assignments-classic-shadow"
                    aria-selected="true">Assignments</a>

            <li class="nav-item m-0">
                <a class="nav-link waves-light" id="members-tab-classic-shadow" data-toggle="tab"

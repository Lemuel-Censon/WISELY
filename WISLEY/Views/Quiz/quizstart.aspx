<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/navbar.Master" AutoEventWireup="true" CodeBehind="quizstart.aspx.cs" Inherits="WISLEY.Views.Quiz.quizcreator" %>
    ...
    <div class="container">
        <div class="card z-depth-3 pb-0 px-0">
            <div class="card-body px-5">
                ...
                <p><asp:Label ID="LbName" runat="server" Text="Label"></asp:Label>, you have no quizzes. Create one now!</p>

                ...
                <div class="card-body px-5">
                    ...
                    <div>
                        <p>An email has been sent to
                            <asp:Label ID="LbEmail" runat="server" Text="Label"></asp:Label>. Please enter the validation code that has been sent to your email. Validation code will expire in 5 minutes.</p>
                    </div>

                        ...
                        <asp:Repeater runat="server" ID="question" OnItemCommand="question_ItemCommand" OnItemDataBound="question_ItemDataBound">
                            <ItemTemplate>
                                <div>
                                    ...
                                    <asp:TextBox runat="server" ID="tbOp1" CssClass="form-control" Text='<%#Eval("option1") %>' Visible="false"></asp:TextBox>
                                    <asp:Label runat="server" ID="qnOp2" CssClass="d-block mt-2" Text='<%#Eval("option2") %>'></asp:Label>
                                    <asp:TextBox runat="server" ID="tbOp2" CssClass="form-control" Text='<%#Eval("option2") %>' Visible="false"></asp:TextBox>
                                    <asp:Label runat="server" ID="qnOp3" CssClass="d-block mt-2" Text='<%#Eval("option3") %>'></asp:Label>
                                    <asp:TextBox runat="server" ID="tbOp3" CssClass="form-control" Text='<%#Eval("option3") %>' Visible="false"></asp:TextBox>
                                    <asp:Label runat="server" ID="qnOp4" CssClass="d-block mt-2" Text='<%#Eval("option4") %>'></asp:Label>
                                    <asp:TextBox runat="server" ID="tbOp4" CssClass="form-control" Text='<%#Eval("option4") %>' Visible="false"></asp:TextBox>
